...
function webforms_design_json_tab() {
    return '
        <div id="webforms-design-json-tab" data-webforms-design-tab-panel="json">
            <h4>JSON</h4>
            <p>This tab shows the browser-local draft model generated by the Design workspace.</p>
            <textarea id="webforms-json-output" class="form-control" rows="18" readonly="readonly" data-webforms-json-output="draft">Loading browser-local draft JSON...</textarea>
        </div>
    ';
}
