...
function webforms_add_design_assets() {
    ...
    if (function_exists('head_add_js')) {
        head_add_js('/addon/webforms/view/js/webforms-design-state.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design-draft.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design-session.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design-package.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design-grid.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design-properties.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design-json.js?v=basic-components-1');
        head_add_js('/addon/webforms/view/js/webforms-design.js?v=basic-components-1');
    }
}
