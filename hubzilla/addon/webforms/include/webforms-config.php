...
return [
    'design_options' => [
        ...
        'ipfs-attest-hubzilla-post' => 'IPFS Attest Hubzilla Post',
        'ldap-bind' => 'LDAP Bind',
    ...
    'design_descriptions' => [
        ...
        'ipfs-attest-hubzilla-post' => 'Browser-local copy of the IPFS Attest Hubzilla Post Webform.',
    ...
    'deploy_package_paths_by_service_pack' => [
        'ipfs' => [
            ...
            'ipfs-attest-hubzilla-post' => 'packages/ipfs/attest-hubzilla-post.json',
        ],
    ],
    'deploy_form_options_by_service_pack' => [
        ...
        'ipfs' => [
            ...
            'ipfs-attest-hubzilla-post' => 'Attest Hubzilla Post',
        ],
        'ldap' => [
            '' => 'Select LDAP webform',
            'ldap-bind' => 'LDAP Bind',
