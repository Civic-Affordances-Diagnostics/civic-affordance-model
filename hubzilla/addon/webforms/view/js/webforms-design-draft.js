(function () {
  ...
  ns.buildDraft = function (runtime) {
    ...
    const routeFormId = designForm || 'new-blank-form';
    ...
    return {
      ...
      form: { id: routeFormId, title: designForm ? ns.humanizeSlug(designForm) : 'New blank form' },
      design: { active_tab: designTab, selected_object_id: null, source: 'browser', route_form_id: routeFormId, next_object_number: 1 },
